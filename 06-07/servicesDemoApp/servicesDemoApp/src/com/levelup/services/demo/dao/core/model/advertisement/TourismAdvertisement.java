 ...
 */
public class TourismAdvertisement extends Advertisement {

    public TourismAdvertisement(String description, String[] photos, User user) {
        super(Section.Tourism, description, photos, user);
    }
}
